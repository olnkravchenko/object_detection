...
def get_thr_prec_rec(gt_boxes, model_scores_map, pred_boxes_pruned, iou_thr=0.5):
    ...
    for ithr, model_score_thr in enumerate(sorted_model_scores[:-1]):
        ...
        for img_id in img_ids:
            ...
            pred_boxes_pruned[img_id]["scores"] = pred_boxes_pruned[img_id]["scores"][
                start_idx:
            ]
            pred_boxes_pruned[img_id]["boxes"] = pred_boxes_pruned[img_id]["boxes"][
                start_idx:
            ]
        ...
        prec, rec = calc_precision_recall(
            img_results
        )  # just summarized results for each image
...
def get_avg_precision_at_iou(gt_boxes, pred_boxes, iou_thr=0.5):
    ...
    model_thrs, precisions, recalls = get_thr_prec_rec(
        gt_boxes, model_scores_map, pred_boxes_pruned, iou_thr
    )
